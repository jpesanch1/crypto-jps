import binascii
from pyemv import cvn, sm, kd, ac
...
def test_visa_cvn10():
    ...
    print(binascii.hexlify(cvn10.icc_mk_ac))
    ...
    print(binascii.hexlify(cvn10._derive_sk_ac_none()))
    ...
    print(binascii.hexlify(cvn10.icc_mk_smi))
    print(binascii.hexlify(cvn10._derive_sk_sm_visa(cvn10.icc_mk_smi, atc)))
...
def test_visa_cvn18():
    ...
    print(binascii.hexlify(cvn18.icc_mk_ac))
    ...
    print(binascii.hexlify(cvn18.icc_mk_smi))
    print(binascii.hexlify(cvn18._derive_sk_sm_visa(cvn18.icc_mk_smi, atc)))
...
if __name__ == "__main__":
    ...
    test_visa_cvn22()
    test_interac_cvn133()
    test_mastercard_cvn16()
    test_mastercard_cvn17()
    test_mastercard_cvn20()
    test_mastercard_cvn21()