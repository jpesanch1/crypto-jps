...
def build_parser():
    my_parser = argparse.ArgumentParser(description="Cipher DES calculator")
...
def parse_commands(subparsers):
    subparse_commands(subparsers)


def subparse_commands(subparsers):
...
def decryption_commands(decrypt_subparsers):
    decrypt_parser = decrypt_subparsers.add_parser("decrypt", help="decrypt data with DES algorithm")
